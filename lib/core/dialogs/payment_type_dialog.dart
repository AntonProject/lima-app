...
Future<PaymentTermsSelection?> showPaymentTypeDialog(BuildContext context) {
  return showModalBottomSheet(
    context: context,
    useRootNavigator: true,
    isScrollControlled: true,
    backgroundColor: Colors.transparent,
    builder: (_) => const _PaymentTypeSheet(),
  );
}

class _PaymentTypeSheet extends StatefulWidget {
  const _PaymentTypeSheet();
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            children: [
              Expanded(
                child: Text(context.l10n.t('paymentTerms'),
          ...
          Text(context.l10n.t('prepayment'),
              style: GoogleFonts.manrope(
              ...
              return Padding(
                ...
                child: GestureDetector(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      color: active ? AppColors.iconBgBlue : AppColors.primaryBg,
          ...
          Container(
            ...
            child: Row(
              children: [
                Expanded(child: _TypeBtn(context.l10n.t('retail'), 0, _buyerType,
                    () => setState(() => _buyerType = 0))),
                Expanded(child: _TypeBtn(context.l10n.t('wholesale'), 1, _buyerType,
                    () => setState(() => _buyerType = 1))),
              ],
            ),
          ),
          const SizedBox(height: 20),
          Text(context.l10n.t('contract'),
              style: GoogleFonts.manrope(
                  fontSize: 13, fontWeight: FontWeight.w600,
                  color: AppColors.secondaryText)),
          const SizedBox(height: 6),
          Text(context.l10n.t('noContracts'),
              style: GoogleFonts.manrope(
...
class _TypeBtn extends StatelessWidget {
  ...
  const _TypeBtn(this.label, this.index, this.current, this.onTap);
